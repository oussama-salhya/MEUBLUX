...
import { createOrderThunk, createPaymentIntentThunk, getAllOrdersThunk, getCustomersThunk, getDashboardInfoThunk, getFilteredOrdersThunk, getSingleProductOrdersThunk, getStatsThunk, getTotalOrdersGroupByCategoriesThunk } from "./orderThunk"
...
export const createPaymentIntent = createAsyncThunk('create-payment-intent', createPaymentIntentThunk)
export const createOrder = createAsyncThunk('create-order', createOrderThunk)
export const getAllOrders = createAsyncThunk('get-all-orders', getAllOrdersThunk)
export const getFilteredOrders = createAsyncThunk('get-filtered-orders', getFilteredOrdersThunk)
export const getTotalOrdersGroupByCategories = createAsyncThunk('get-total-orders-by-categories', getTotalOrdersGroupByCategoriesThunk)
export const getCustomers = createAsyncThunk('get-customers', getCustomersThunk)
export const getDashboardInfo = createAsyncThunk('get-dashboard-info', getDashboardInfoThunk)
export const getStats = createAsyncThunk('get-stats', getStatsThunk)
export const getSingleProductOrders = createAsyncThunk('get-product-orders', getSingleProductOrdersThunk)
    ...
    extraReducers: {
        ...
        [getAllOrders.fulfilled]: (state, { payload }) => {
            ...
            if (payload.categories && payload.companies && payload.cities) {
                ...
                state.citiesOptions = payload.cities.map(city => ({ name: city, enabled: true }))
            }
