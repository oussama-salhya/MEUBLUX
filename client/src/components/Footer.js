      ...
      <div className="container">
        ...
        <div className="footer-info">
          <div>
            ...
            <p>
              16 Boulevard Mers Sultan <br />
              75005 Casablanca, <br />
              Morroco
            </p>
          </div>
          <div>
            <h4 className="footer-title">Phone / Email</h4>
            <p>
              <span>oussamasalhya@gmail.com</span>
              <span>+212 7 06 25 79 04</span>
            </p>
          </div>
          <div>
            ...
            <div className="icons">
              <a
                href="https://www.oussama-salhya.me/"
                target="_blank"
              ...
              <a
                href="https://www.linkedin.com/in/oussama-salhya/"
                target="_blank"
                rel="noopener noreferrer"
              >
                <BsTwitter />
